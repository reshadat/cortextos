...
Confirm to user:
```bash
officeos bus send-telegram $CTX_TELEGRAM_CHAT_ID "Queued X tasks for overnight work:
- [Task 1] -> [agent]
- [Task 2] -> [agent]
...
# Update heartbeat
officeos bus update-heartbeat "evening review complete - transitioning to nighttime mode"
