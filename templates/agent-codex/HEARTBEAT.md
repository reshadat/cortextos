...
If any of those messages were Telegram-shape (`=== TELEGRAM from`), you should already have replied via `officeos bus send-telegram` when they first arrived — if not, do it NOW before continuing.
