...
export const dashboardCommand = new Command('dashboard')
  ...
  .description('Start the officeOs dashboard (Next.js)')
  .action(async (options: { port: string; instance: string; build?: boolean; install?: boolean }) => {
    ...
    if (!adminPassword) {
      ...
      console.error('Run: officeos install  (auto-generates dashboard credentials)');
    ...
    const nextEnvLines = [
      '# AUTO-GENERATED by officeos dashboard. To change credentials, edit:',
    ...
    // stops; forward them to the child so `officeos dashboard` started
